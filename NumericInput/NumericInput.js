                ...
                <Button onPress={this.dec} style={leftButtonStyle}>
                 ...
                 type='font-awesome'
                   color='white'
                    ...
                    size={18} style={[...iconStyle, maxReached ? this.props.reachMaxDecIconStyle : {}, minReached ? this.props.reachMinDecIconStyle : {}]} />
                    :
                    <Icon 
                    name='minus'
        type='font-awesome'
        color='white'
                     size={fontSize} style={[...iconStyle, maxReached ? this.props.reachMaxDecIconStyle : {}, minReached ? this.props.reachMinDecIconStyle : {}]} />
                    }
                ...
                <Button onPress={this.inc} style={rightButtonStyle}>
                    <Icon name='plus'
        type='font-awesome'
        color='white' size={fontSize} style={[...iconStyle, maxReached ? this.props.reachMaxIncIconStyle : {}, minReached ? this.props.reachMinIncIconStyle : {}]} />
                </Button>
            </View>)
...
NumericInput.defaultProps = {
    ...
    maxValue: null,
    step: 1,
    upDownButtonsBackgroundColor: '#E75600',
    rightButtonBackgroundColor: '#E75600',
    leftButtonBackgroundColor: '#E75600',
    editable: true,
    validateOnBlur: true,
